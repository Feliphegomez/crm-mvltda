		...
		<div class="container">
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" data-aos="zoom-in">
				...
				<div class="agileinfo_footer_grid1">
					<a href="#"><img src="<?php echo $website->get_assets_folder(); ?>images/f1.jpg" alt=" " class="img-responsive"></a>
				</div>
				<div class="agileinfo_footer_grid1">
					<a href="#"><img src="<?php echo $website->get_assets_folder(); ?>images/f2.jpg" alt=" " class="img-responsive"></a>
				</div>
				<div class="agileinfo_footer_grid1">
					<a href="#"><img src="<?php echo $website->get_assets_folder(); ?>images/f3.jpg" alt=" " class="img-responsive"></a>
				</div>
				<div class="agileinfo_footer_grid1">
					<a href="#"><img src="<?php echo $website->get_assets_folder(); ?>images/f4.jpg" alt=" " class="img-responsive"></a>
				</div>
				<div class="agileinfo_footer_grid1">
					<a href="#"><img src="<?php echo $website->get_assets_folder(); ?>images/f5.jpg" alt=" " class="img-responsive"></a>
				</div>
				<div class="agileinfo_footer_grid1">
					<a href="#"><img src="<?php echo $website->get_assets_folder(); ?>images/f6.jpg" alt=" " class="img-responsive"></a>
				</div>
