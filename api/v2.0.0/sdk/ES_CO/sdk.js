...
FG = {
	...
	init: function(options) {
		...
		var s = this;
		s.Modal.loadStyle();
		if(!options.host || !options.path_api) { throw new s.exceptionFG('Opciones de init() incompletas o invalidas.'); };
		s.config = options;
		s.session_check();
		Vue.FG = s;
	},
	url_api_use: function(){
		return this.config.host + this.config.path_api + '/records';
	},
	...
	url_api: function(){
		var s = this;
		var tu = s.config.host + s.config.path_api;
		return tu;
	},
